...
export default function FarfallaStore() {
  ...
  const [productos, setProductos] = useState([
    {
      id: 1,
      nombre: "Pijama Tropical Fruta",
      precio: 65000,
      desc: "Estilo tropical colorido",
      color: "multicolor",
      talla: "m",
      imagenes: [
        "https://images.unsplash.com/photo-1612873087320-61b96c2377e6?w=400&h=400&fit=crop",
      ],
      calificacion: 4.5,
      resenas: 12,
      material: "100% algodón franela",
    ...
    {
      id: 2,
      nombre: "Pijama Stitch Morado",
      precio: 58000,
      desc: "Diseño exclusivo cómodo",
      color: "morado",
      talla: "l",
      imagenes: [
        "https://images.unsplash.com/photo-1618886996285-6abaf18d3d23?w=400&h=400&fit=crop",
      ],
      calificacion: 5,
      resenas: 8,
      material: "100% algodón franela",
    ...
    {
      id: 3,
      nombre: "Pijama Corazones Rosa",
      precio: 60000,
      desc: "Romántico y acogedor",
      color: "rosa",
      talla: "m",
      imagenes: [
        "https://images.unsplash.com/photo-1630599810032-47df8e1c8f88?w=400&h=400&fit=crop",
      ],
      calificacion: 4.8,
      resenas: 15,
      material: "100% algodón franela",
  ...
  const contactarWhatsApp = (mensaje) => {
    window.open(
      `https://wa.me/573172850958?text=${encodeURIComponent(mensaje)}`,
      "_blank"
    );
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 text-slate-800 overflow-hidden">
      ...
      <div className="relative z-10">
            ...
            <div className="flex items-center justify-between h-16 sm:h-20">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-teal-600 font-bold tracking-widest">
                    PREMIUM SLEEPWEAR
                  </p>
                </div>
              </div>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
          ...
          <div className="relative max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4">
              Pijamas 100% algodón franela con diseños que transformarán tus
              noches en una experiencia de lujo absoluto
            </p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto mb-8 sm:mb-12 px-4">
              {[
                ...
                <div
                  key={idx}
                  className={`group p-3 sm:p-4 bg-gradient-to-br ${
                    item.color
                  } border border-${
                    item.color.split("-")[1]
                  }-200 rounded-2xl hover:shadow-lg transition-all cursor-pointer`}
                >
        ...
        <section className="max-w-6xl mx-auto px-4 py-6 sm:py-8 relative z-20">
          <div className="relative">
            <Search
              className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-teal-500"
              size={20}
            />
            <input
              type="text"
        ...
        <section
          id="productos"
          className="max-w-7xl mx-auto px-4 py-12 sm:py-16 relative z-20"
        >
          ...
          <p className="text-center text-slate-600 mb-8 sm:mb-12 text-base sm:text-lg px-4">
            Cada pijama es una obra de arte diseñada para tu confort
          </p>
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-2 sm:mb-3">
                      ...
                      >
                        <Heart
                          size={18}
                          className="sm:w-5 sm:h-5 text-rose-400 hover:fill-rose-400"
                        />
                      </button>
                    </div>
        ...
        <footer className="border-t border-teal-200 mt-12 sm:mt-20 py-8 sm:py-12 relative z-20 bg-white/50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12">
              <div>
                <h3 className="text-base sm:text-lg font-black text-teal-600 mb-3 sm:mb-4">
                  FARFALLA
                </h3>
                <p className="text-slate-600 text-sm">
                  Pijamas de lujo para tus noches más cómodas. Hecho en Colombia
                  con amor.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://instagram.com/farfallapijamas"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-lg text-white text-lg sm:text-xl"
                  >
                    📷
                  </a>
                  <a
                    href="https://wa.me/573172850958"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-lg text-white text-lg sm:text-xl"
                  >
                    💬
                  </a>
                </div>
            ...
            <div className="border-t border-teal-200 pt-6 sm:pt-8 text-center text-slate-500 text-xs sm:text-sm">
              <p>
                © 2025 Farfalla Pijamas. Todos los derechos reservados.{" "}
                ...
                {!adminAutenticado ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                      <h3 className="font-black text-amber-600 mb-4 text-base sm:text-lg">
                        📝 EDITAR PRODUCTOS
                      </h3>
                      {productos.map((prod) => (
                        <div
                          key={prod.id}
                          className="bg-white p-3 sm:p-4 rounded-lg mb-4 border border-amber-200 shadow-sm"
                        >
                          <input
                            type="text"
                            value={prod.nombre}
                    ...
                    <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
                      <h3 className="font-black text-teal-600 mb-4 text-base sm:text-lg">
                        ➕ AGREGAR PRODUCTO
                      </h3>
                      <div className="space-y-3">
                        ...
                        />
                        <div>
                          <label className="block text-xs sm:text-sm font-bold text-teal-600 mb-2">
                            📸 Imagen
                          </label>
                          <input
                            type="file"
